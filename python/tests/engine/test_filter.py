...
def test_filter_numeric_gte():
    ...
    assert result.loc[0, "count"] == 100
    assert result.loc[1, "count"] == 110
    assert result.loc[2, "count"] == 120
...
def test_filter_numeric_gt():
    ...
    assert result.loc[0, "count"] == 110
    assert result.loc[1, "count"] == 120
...
def test_filter_numeric_lt():
    ...
    assert result.loc[0, "count"] == 80
    assert result.loc[1, "count"] == 90
...
def test_filter_string_empty():
    ...
    assert result.loc[0, "quantity"] == 78
    assert result.loc[1, "quantity"] == 45
