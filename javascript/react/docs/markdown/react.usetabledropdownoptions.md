...
[Home](./index.md) &gt; [@datashaper/react](./react.md) &gt; [useTableDropdownOptions](./react.usetabledropdownoptions.md)

## useTableDropdownOptions() function
...
```typescript
export declare function useTableDropdownOptions(workflow?: Workflow): IDropdownOption[];
```
