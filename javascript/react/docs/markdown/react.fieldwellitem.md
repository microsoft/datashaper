...
Defines an available field well. This includes UX properties for how to visually represent it (title, icon, etc). This implementation is rendered as a dropdown.
...
|  [options?](./react.fieldwellitem.options.md) |  | IDropdownOption\[\] | <i>(Optional)</i> List of valid options that this field well can be set to. |
