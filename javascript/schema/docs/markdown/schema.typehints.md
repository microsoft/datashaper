...
|  [falseValues?](./schema.typehints.falsevalues.md) |  | string\[\] | <i>(Optional)</i> Default: case-insensitive word "false". Note that if you configure this, pandas considers the custom values case-sensitive. Case-insensitive true/false is always valid. |
...
|  [trueValues?](./schema.typehints.truevalues.md) |  | string\[\] | <i>(Optional)</i> Default: case-insensitive word "true". Note that if you configure this, pandas considers the custom values case-sensitive. Case-insensitive true/false is always valid. |
