...
|  --- | --- | --- | --- |
|  [emitRemainder?](./schema.sampleargs.emitremainder.md) |  | boolean | <i>(Optional)</i> Whether to preserve and emit the non-sampled records via the 'remainder' output port. |
