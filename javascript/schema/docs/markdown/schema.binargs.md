...
|  [nice?](./schema.binargs.nice.md) |  | boolean | <i>(Optional)</i> Indicates whether bins should be rounded in a readable human-friendly way. |
|  [printRange?](./schema.binargs.printrange.md) |  | boolean | <i>(Optional)</i> If true, the range for each bin will be printed as the cell value instead of the truncated numeric value. |
|  [strategy](./schema.binargs.strategy.md) |  | [BinStrategy](./schema.binstrategy.md) | Binning technique to use. |
