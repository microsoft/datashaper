...
|  [input?](./workflow.stepinput.input.md) |  | string \| ({ others?: PortBinding\[\]; } &amp; Record&lt;string, PortBinding&gt;) | <i>(Optional)</i> The bound inputs Key = Input Socket Name Value = Socket Binding to other node |
