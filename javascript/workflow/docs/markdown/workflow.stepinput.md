...
|  [input?](./workflow.stepinput.input.md) |  | WorkflowStepId \| Record&lt;string, WorkflowInput \| WorkflowInput\[\] \| undefined&gt; | <i>(Optional)</i> The bound inputs Key = Input Socket Name Value = Socket Binding to other node |
