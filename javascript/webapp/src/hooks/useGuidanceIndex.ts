...
export function useGuidanceIndex(): {
	...
	return {
		prepareDataPage: CONTENT,
	}
}

const CONTENT = `
The workflow builder web application allows you to perform lightweight data wrangling by constructing a series of transformation steps.
