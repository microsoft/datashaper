...
|  [ProfileFieldWell](./app-framework.profilefieldwell.md) | Defines an available resource slot for a profile. This includes UX properties for how to visually represent it (title, icon, etc). |
